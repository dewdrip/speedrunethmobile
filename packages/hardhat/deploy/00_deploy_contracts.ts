  ...
  */
  ...
  if (hre.network.name == 'localhost') {
    ...
    await cornToken.mintTo(
      movePrice.address,
      hre.ethers.parseEther('10000000000000000000000')
    );
    ...
    await cornToken.approve(
      cornDEX.target,
      hre.ethers.parseEther('1000000000')
    );
    await cornDEX.init(hre.ethers.parseEther('1000000000'), {
      value: hre.ethers.parseEther('1000000')
    });
  }
};
