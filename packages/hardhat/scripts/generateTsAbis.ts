 ...
 * These definitions are used to derive the types needed in the custom eth-mobile hooks, for example.
...
const generateTsAbis: DeployFunction = async function () {
  ...
  fs.writeFileSync(
    ...
    await prettier.format(
      `${generatedContractComment} import { GenericContractsDeclaration } from "../src/utils/eth-mobile/contract"; \n\n
