...
describe('🚩 Challenge 2: 🏵 Token Vendor 🤖', function () {
  ...
  it('Should deploy YourToken', async function () {
    const YourTokenFactory = await ethers.getContractFactory(
  ...
  describe(' 💵 buyTokens()', function () {
    it('Should let us buy tokens and our balance should go up...', async function () {
      ...
      console.log(
        ...
        ethers.formatEther(startingBalance)
      );
  ...
  describe(' 💵 sellTokens()', function () {
    it('Should let us sell tokens and we should get the appropriate amount eth back...', async function () {
      ...
      console.log(
        ...
        ethers.formatEther(startingETHBalance)
      );
      ...
      console.log(
        '\t',
        ' 🔎 New ETH balance: ',
        ethers.formatEther(newETHBalance)
      );
  ...
  describe(' 💵 withdraw()', function () {
    it('Should let the owner (and nobody else) withdraw the eth from the contract...', async function () {
      ...
      console.log(
        ...
        ethers.formatEther(vendorETHBalance)
      );
      ...
      console.log(
        ...
        ethers.formatEther(startingNonOwnerETHBalance)
      );
      ...
      console.log(
        ...
        ethers.formatEther(newNonOwnerETHBalance)
      );
      ...
      console.log(
        ...
        ethers.formatEther(startingOwnerETHBalance)
      );
      ...
      console.log(
        ...
        ethers.formatEther(newOwnerETHBalance)
      );
